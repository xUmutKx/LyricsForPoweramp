...
class GeminiAiProvider(
    ...
    override suspend fun getSupportedLanguages(lyrics: String): List<String>? {
        val prompt = """
        ...
        return when (response) {
            is Result.Success -> {
                if (response.response.trim() == "FAILED") null else response.response.split(",")
