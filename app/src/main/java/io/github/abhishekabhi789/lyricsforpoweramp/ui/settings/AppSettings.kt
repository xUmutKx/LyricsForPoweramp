    ...
    Scaffold(
        ...
        NavHost(
            ...
            composable<SettingsCategory.Request> {
                LyricsRequestSettings(viewmodel = viewmodel)
            }
            composable<SettingsCategory.Storage> { backStackEntry ->
                ...
                LyricsStorageSettings(viewmodel = viewmodel)
            }
            composable<SettingsCategory.LyricsProvider> {
                LyricsProviderSettings(viewmodel = viewmodel)
            }
            composable<SettingsCategory.Editor> {
                EditorSettings(viewmodel = viewmodel)
            }
